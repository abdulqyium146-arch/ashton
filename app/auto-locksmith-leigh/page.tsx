...
export const metadata: Metadata = {
  ...
  description: 'Auto locksmith serving Leigh, Atherton and Tyldesley. Car lockouts, car key replacement & programming. 24/7 mobile service, fixed price. Call 07711 341668.',
  alternates: {
...
const faqs = [
  {
    ...
    answer: 'Approximately 7–9 miles depending on the route. Our typical response time to Leigh, Atherton, and Tyldesley is 25–40 minutes. We\'re on the road 24/7 so late-night and early-morning call-outs are no problem.',
  },
  {
    question: 'Do you replace car keys in Leigh?',
    answer: 'Yes — we carry programming equipment and key blanks on the van. For most makes we can cut and programme a replacement key at your vehicle in Leigh the same day. Lost all keys? We handle AKL (all-keys-lost) jobs too.',
  },
  {
    question: 'What auto locksmith services do you offer in Leigh?',
    answer: 'The full range — car lockouts, car key replacement and programming, transponder key programming, key fob repair, ignition repair, broken key extraction, and van locksmith services including deadlock fitting.',
  },
]
    ...
    <>
      ...
      <section className="bg-brand-navy section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Covering Leigh, Atherton &amp; Tyldesley — 24/7
          </div>
          ...
          <p className="text-xl text-white/70 mb-8 leading-relaxed">
            ...
            Ashton Lock &amp; Key is typically on-site within 30–40 minutes — 24 hours a day, fixed prices upfront.
          </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <ul>
            <li><Link href="/car-lockout-service-ashton">Car lockout service</Link> — non-destructive entry, no damage, any hour</li>
            <li><Link href="/car-key-replacement-ashton">Car key replacement</Link> — cut and programmed at your vehicle</li>
            <li><Link href="/lost-car-keys-ashton">Lost car keys / AKL</Link> — all keys lost programming from scratch</li>
            <li><Link href="/transponder-key-programming-ashton">Transponder key programming</Link> — chip programming for all makes</li>
            <li><Link href="/car-key-fob-replacement-ashton">Key fob replacement</Link> — re-sync, repair, or full replacement</li>
            <li><Link href="/van-locksmith-ashton">Van locksmith</Link> — commercial vehicle lockouts and security</li>
          </ul>

          <h2>Response Times for Leigh</h2>
          <p>
            From our base in Ashton-in-Makerfield to central Leigh is approximately 7–9 miles via the A579.
            Typical response time is 25–40 minutes, depending on traffic. At night and on weekends when roads are
            clearer, we&apos;re often faster. We&apos;ll give you a realistic ETA when you call — not an optimistic
            estimate that turns into a longer wait.
          </p>

          <h2>Pricing</h2>
          <p>
            All prices are quoted over the phone before we attend. Standard daytime car lockout from £60.
            Out-of-hours from £80. Car key replacement from £80 depending on key type. For transparent pricing
      ...
      <CTASection
        ...
        subtext="Call Ashton Lock & Key — typically on-site in 30–40 minutes, 24/7, fixed price."
      />
