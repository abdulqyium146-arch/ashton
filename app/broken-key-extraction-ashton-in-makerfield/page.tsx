...
export const metadata: Metadata = {
  ...
  description: 'Key snapped in door lock or ignition in Ashton-in-Makerfield? We extract broken key fragments without damaging the barrel, then cut a replacement on the same visit. Call 07309 903243.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes â€” this is the most common scenario. Once the broken fragment is removed, we cut a new key to the barrel profile and, if it\'s a transponder or remote key, programme it to the vehicle on the same visit. You leave with a fully working key in most cases.',
  },
  {
    question: 'Why did my key snap in the lock?',
    answer: 'Most key breaks happen when there is existing wear on the key blade combined with some resistance in the barrel â€” often caused by a stiff lock, misalignment, or attempting to turn the key at an awkward angle. Keys with cuts near the tip are more prone to snapping. Worn keys should be replaced before they break completely.',
  },
  {
    question: 'How long does broken key extraction take?',
    answer: 'Extraction alone typically takes 15â€“30 minutes depending on how deep the fragment is and whether it has moved within the barrel. If we\'re cutting and programming a replacement key in the same visit, add a further 30â€“45 minutes for most transponder key types.',
  },
  {
    question: 'How much does broken key extraction cost?',
    answer: 'Extraction starts from Â£60â€“Â£80 depending on lock type and time of day. If a replacement key is needed, that is priced separately based on the key type. The full cost is confirmed over the phone before we attend.',
  },
]
...
export default function BrokenKeyExtractionAshtonPage() {
  ...
  const schemas = [
    serviceSchema('Broken Key Extraction Ashton-in-Makerfield', 'Professional broken key extraction in Ashton-in-Makerfield. Fragment removed without barrel damage â€” replacement key cut and programmed on the same visit.', pageUrl),
    faqSchema(faqs),
    ...
    webPageSchema({ url: pageUrl, title: 'Broken Key Extraction Ashton-in-Makerfield | Mobile', description: 'Broken key extraction in door lock or ignition â€” Ashton-in-Makerfield. Fragment removed, replacement cut same visit.', type: 'WebPage' }),
  ]
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-navy to-brand-blue section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Mobile Broken Key Extraction â€” Ashton-in-Makerfield &amp; Wigan
          </div>
          ...
          <p className="text-xl text-white/70 mb-4 leading-relaxed">
            Key snapped in the door lock or ignition? Don&apos;t try to dig it out yourself â€” improvised tools
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            A snapped key in a door lock or ignition is one of the more frustrating vehicle emergencies â€”
          ...
          <p>
            ...
            penetrating lubricant to ease the fragment. Dedicated extraction tools â€” a combination of
            hook picks and spiral extractors â€” are then used to engage the fragment and draw it out
          ...
          <p>
            ...
            we leave â€” there is no need for a second visit or separate appointment.
          </p>
          <h3>Pricing</h3>
          <p>
            Extraction starts from <strong>Â£60</strong> (daytime) and <strong>Â£80</strong> (out-of-hours).
            If a replacement key is required, the cost is quoted separately based on key type. Full
            pricing is confirmed over the phone before we set off â€” no hidden extras.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-white" aria-labelledby="vehicles-heading">
        <div className="container-max max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-6 max-w-2xl mx-auto">
            ...
            If your make isn&apos;t listed, call us â€” our extraction tool kit covers virtually every vehicle
            on UK roads.
          </p>
          ...
          <p className="text-center text-gray-500 text-sm">
            <a href={`tel:${BUSINESS.phone}`} className="text-brand-orange font-semibold hover:underline">Call {BUSINESS.phoneDisplay}</a> â€” we&apos;ll confirm coverage and give you a fixed price.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="prose-custom">
              <p>
                ...
                We provide mobile broken key extraction across our full service area â€” no need to arrange
      ...
      <CTASection variant="orange" heading="Key Snapped in Ashton-in-Makerfield?" subtext="Call Ashton Lock & Key â€” we extract the fragment and cut a replacement key on the same visit." />
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { title: 'Transponder Key Programming', desc: 'Replacement key needs chip programming â€” we do it on-site.', href: '/transponder-key-programming-ashton-in-makerfield' },
