...
export const metadata: Metadata = {
  ...
  description: 'Mobile car key replacement in Ashton-in-Makerfield. Transponder keys, remote fobs & smart keys cut & programmed on-site. 40–60% cheaper than dealer. Call 07711 341668.',
...
const faqs = [
  {
    ...
    answer: 'Pricing depends on key type. A basic transponder key starts from around £80–£120 including programming. Remote fobs start from £100–£160. Smart/proximity keys start from £180–£280. All prices are quoted over the phone before we attend and are fixed — no surprises.',
  },
  {
    question: 'Can you replace a car key without the original?',
    answer: 'Yes, as long as you have at least one working key. We cut a new blade to match and programme a new transponder to the vehicle. If you have no working keys at all, that becomes an all-keys-lost (AKL) job — see our lost car key service for that scenario.',
  },
  {
    question: 'How long does car key replacement take?',
    answer: 'For most straightforward transponder key or remote fob replacements, we complete the job in 30–60 minutes on-site. Smart key programming can take slightly longer. We come directly to your vehicle, so there\'s no need for you to arrange recovery or travel anywhere.',
  },
  {
    question: 'Is a mobile car key replacement as good as the dealer?',
    answer: 'Yes — we use the same AUTEL and Xhorse diagnostic equipment that main dealers use, along with OEM-specification key blanks. The programming is identical. The key will start your engine and operate all remote functions exactly as a dealer replacement would, at 40–60% of the cost.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Have your V5C logbook, photo ID (driving licence or passport), and proof of address ready. This is standard practice for any responsible locksmith — it protects you and ensures we only programme keys to the rightful owner of the vehicle.',
  },
]
...
export default function CarKeyReplacementAshtonPage() {
  ...
  const schemas = [
    serviceSchema('Car Key Replacement Ashton-in-Makerfield', 'Mobile car key replacement in Ashton-in-Makerfield. Transponder keys, remote fobs, and smart keys cut and programmed on-site — same day, 40–60% cheaper than dealer.', pageUrl),
    faqSchema(faqs),
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-brand-navy to-brand-blue section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Same-Day Car Key Replacement — Ashton-in-Makerfield &amp; Wigan
          </div>
          ...
          <p className="text-xl text-white/70 mb-4 leading-relaxed">
            ...
            specialist — we cut and programme transponder keys, remote fobs, and smart keys on-site at your vehicle,
          ...
          <p className="text-lg text-white/60 mb-8 leading-relaxed">
            ...
            for 40–60% less than the main dealer quote.
          </p>
          <div className="flex flex-wrap gap-3 mb-8">
            {['No Call-Out Fee', 'Same-Day Service', '40–60% Cheaper Than Dealer', 'All Key Types', 'Fixed Price Upfront'].map(t => (
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            ...
            transponder chip that communicates with your vehicle&apos;s immobiliser — if the chip isn&apos;t
          ...
          <p>
            ...
            ECU. This covers the majority of Ford, Vauxhall, Volkswagen, Renault, Peugeot, and Citroën models
            on UK roads. Work is completed on-site, typically within 30–45 minutes.
          </p>
          ...
          <p>
            ...
            makes. The key is supplied and programmed to your vehicle in a single visit — no dealer appointment
            required.
          </p>
          ...
          <p>
            ...
            guide: transponder keys from <strong>£80</strong>, remote fobs from <strong>£100</strong>, smart
            keys from <strong>£180</strong>. Have your V5C logbook and photo ID ready — a responsible locksmith
        ...
        <div className="container-max max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="prose-custom">
              ...
              <p>
                We come directly to your vehicle — at home, work, or wherever you are. Our mobile service
                covers:
              </p>
              <ul>
      ...
      <CTASection variant="orange" heading="Need a Car Key in Ashton-in-Makerfield?" subtext="Call Ashton Lock & Key — mobile, same-day, all key types. 40–60% cheaper than the main dealer." />
