...
export const metadata: Metadata = {
  ...
  description: 'Locked out of your car in Ashton-in-Makerfield? We open vehicles 24/7 without damage. 20–30 min response. No call-out fee. Call 07711 341668 now.',
...
const faqs = [
  {
    ...
    answer: 'From the moment you call, we typically arrive within 20–30 minutes for locations in WN4. Opening the vehicle takes a further 10–20 minutes on-site using professional non-destructive entry tools. Most customers are back in their car within an hour of calling.',
  },
  {
  ...
  },
  {
    ...
    answer: 'This is a common variation of the car lockout scenario. We open the vehicle using non-destructive entry, then assess the key situation. If the key is stuck in the ignition we can address that separately — see our ignition repair service.',
  },
  {
    question: 'How much does a car lockout service cost in Ashton-in-Makerfield?',
    answer: 'Standard daytime lockout (07:00–20:00) starts from £60. Out-of-hours (20:00–07:00) starts from £80. The exact price is confirmed over the phone before we attend — what we quote is what you pay.',
  },
  {
    question: 'Do you cover car lockouts across the Wigan area?',
    answer: 'Yes. We cover Ashton-in-Makerfield, Wigan, Golborne, Bryn, Haydock, Newton-le-Willows, Leigh, Garswood, and Billinge. If you\'re unsure whether we reach your location, call us — we\'ll give you an honest answer.',
  },
  {
    question: 'Do you open vans and commercial vehicles too?',
    answer: 'Yes. We open cars, vans, and light commercial vehicles. Transit, Vivaro, Sprinter, Transporter — all common van makes are covered using the same non-destructive entry approach.',
  },
]
...
export default function CarLockoutAshtonPage() {
  ...
  const schemas = [
    serviceSchema('Car Lockout Service Ashton-in-Makerfield', 'Professional car lockout service in Ashton-in-Makerfield. Non-destructive vehicle entry — 24/7, 20–30 min response, no damage guaranteed.', pageUrl),
    faqSchema(faqs),
    ...
    webPageSchema({ url: pageUrl, title: 'Car Lockout Service Ashton-in-Makerfield | 24/7', description: 'Non-destructive car lockout service in Ashton-in-Makerfield. 24/7, 20–30 min response.', type: 'WebPage' }),
  ]
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-navy to-brand-blue section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Available Now — 24/7 Car Lockout Service, Ashton-in-Makerfield
          </div>
          ...
          <p className="text-xl text-white/70 mb-4 leading-relaxed">
            ...
            simply lost them, Ashton Lock &amp; Key is your nearest mobile car locksmith — available 24 hours a day,
            seven days a week with no call-out fee.
          </p>
          <p className="text-lg text-white/60 mb-8 leading-relaxed">
            We use professional non-destructive entry techniques to open your vehicle cleanly — no broken glass,
            ...
            20–30 minutes of your call.
          </p>
          <div className="flex flex-wrap gap-3 mb-8">
            {['No Call-Out Fee', '24/7 Service', '20–30 Min Response', 'No Damage Guaranteed', 'Fixed Price Upfront'].map(t => (
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            Being locked out of your car is stressful at any time — but especially at night, in an unfamiliar
            ...
            speak directly to the locksmith — not a national call centre that patches you through to whoever
          ...
          <p>
            ...
            We use air wedge sets to create a controlled, temporary gap between the door and frame — wide enough
          ...
          <ul>
            ...
            <li>Keep your phone on — we may call to confirm your exact position</li>
            <li>If you're in an unsafe location (dark car park, roadside on a fast road), move to a safer spot nearby</li>
            <li>Do not attempt to force entry yourself — improvised tools damage seals and can trigger deadlocking</li>
          </ul>
          ...
          <p>
            ...
            call 999 first — police have authority to break a window lawfully. If the situation is not
          ...
          <h3>Pricing — Confirmed Before We Attend</h3>
          <p>
            Standard daytime lockout (07:00–20:00): from <strong>£60</strong>. Out-of-hours: from <strong>£80</strong>.
            All prices are fixed and confirmed over the phone before we set off. There are no hidden extras —
      ...
      <section className="section-padding bg-white" aria-labelledby="vehicles-heading">
        <div className="container-max max-w-4xl mx-auto">
          ...
          <p className="text-center text-gray-500 text-sm">
            Don&apos;t see your make? <a href={`tel:${BUSINESS.phone}`} className="text-brand-orange font-semibold hover:underline">Call us</a> — we almost certainly cover it.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="prose-custom">
              <p>
                ...
                putting us within 20–30 minutes of the vast majority of WN4 call-outs.
              </p>
              <p>
                As a <strong>mobile locksmith near Ashton-in-Makerfield</strong>, we come to wherever you and
                your vehicle are — home, work, a supermarket car park, roadside, anywhere within our service
      ...
      <CTASection variant="orange" heading="Locked Out of Your Car in Ashton-in-Makerfield?" subtext="Call Ashton Lock & Key now — 24/7, no call-out fee, fixed price, typically on-site in 20–30 minutes." />
      ...
      <section className="section-padding bg-brand-light">
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: 'Emergency Auto Locksmith', desc: '24/7 emergency auto locksmith — any situation, fast response.', href: '/emergency-auto-locksmith-ashton-in-makerfield' },
              ...
              { title: 'Auto Locksmith Ashton', desc: 'Full auto locksmith service hub — all vehicle situations.', href: '/auto-locksmith-ashton-in-makerfield' },
