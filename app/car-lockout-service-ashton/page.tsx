...
export const metadata: Metadata = {
  ...
  description: 'Locked your keys in your car near Ashton-in-Makerfield? Ashton Lock & Key opens vehicles without damage â€” 24/7, 30-min response, no call-out fee. Call 07309 903243.',
  alternates: {
...
const faqs = [
  {
    ...
    answer: 'We use professional non-destructive entry tools â€” specialised wedge sets and long-reach tools that allow us to operate the internal handle or unlock button without touching the glass, paintwork, or door seals. No drilling, no damage. The technique varies by vehicle make and model.',
  },
  {
    question: 'Will my car be damaged when you open it?',
    answer: 'No. Non-destructive entry is the industry standard technique and causes no damage when performed correctly by an experienced auto locksmith. We open cars professionally every day â€” your vehicle will look exactly the same as it did before we arrived.',
  },
  {
    question: 'I\'ve locked my keys in my car at night â€” can you still come out?',
...
export default function CarLockoutPage() {
  ...
  const schemas = [
    serviceSchema(
      ...
      'Professional car lockout service in Ashton-in-Makerfield. Non-destructive vehicle entry â€” no damage, fast response. Available 24/7 across Wigan.',
      pageUrl,
    ),
    faqSchema(faqs),
    breadcrumbSchema([
    ...
    <>
      ...
      <section className="bg-brand-navy section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-3xl">
          ...
          <p className="text-xl text-white/70 mb-8 leading-relaxed">
            ...
            without causing any damage â€” 24 hours a day, 7 days a week. We&apos;re based in Ashton-in-Makerfield
      ...
      <section className="section-padding bg-brand-light" aria-labelledby="steps-heading">
        <div className="container-max max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              { step: '1', title: 'You Call â€” We Answer', desc: 'Ring 07309 903243 any time. You speak directly to the locksmith, not a call centre. Tell us where you are and what\'s happened.' },
              ...
              { step: '3', title: 'We Come to You', desc: 'We head directly to your location â€” car park, roadside, home, work, wherever. Most Ashton-in-Makerfield call-outs take under 30 minutes.' },
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <h2>Non-Destructive Car Entry â€” No Damage Guaranteed</h2>
          <p>
            ...
            It leaves no trace â€” no scratches, no bent frames, no cracked seals.
          </p>
          <p>
            ...
            isn&apos;t possible for a specific vehicle, we&apos;ll tell you that upfront and discuss alternatives â€”
            we won&apos;t start work without your agreement.
          </p>

          <h2>Common Car Lockout Situations We Handle</h2>
          <ul>
            <li>Keys locked inside the car â€” including with engine running</li>
            <li>Key fob battery flat â€” central locking not responding</li>
            ...
            <li>Key broken off in the door lock â€” see our <Link href="/broken-car-key-extraction-ashton">broken key extraction service</Link></li>
          </ul>

          <h2>Pricing â€” Transparent &amp; Fixed</h2>
          <p>
            Standard daytime car lockout (07:00â€“20:00): from <strong>Â£60</strong>.<br />
            Out-of-hours (20:00â€“07:00): from <strong>Â£80</strong>.<br />
            Prices confirmed over the phone before we attend. What we quote is what you pay â€” full stop.
          </p>
          <p>
          ...
          <p>
            Once you&apos;ve called us, there&apos;s not a lot to do â€” but here&apos;s what helps:
          </p>
          <ul>
            <li>Stay with or near the vehicle if it&apos;s safe to do so</li>
            <li>Keep your phone on â€” we may call to confirm your exact location</li>
            <li>If you&apos;re in an unsafe location (e.g. a dark car park late at night), move to a visible, lit area nearby</li>
            <li>Don&apos;t attempt to break in yourself â€” you risk damaging the door, and some techniques (coat hanger, screwdriver) will trigger the central locking immobiliser</li>
          </ul>
          ...
          <p>
            ...
            it â€” often on the same visit. See our full list of{' '}
      ...
      <section className="section-padding bg-brand-light">
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: 'Auto Locksmith Ashton', desc: 'Full auto locksmith service â€” all vehicle situations.', href: '/auto-locksmith-ashton-in-makerfield' },
