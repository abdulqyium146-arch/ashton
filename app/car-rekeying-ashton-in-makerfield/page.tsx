...
export const metadata: Metadata = {
  ...
  description: 'Car rekeying in Ashton-in-Makerfield — new lock barrels, erase old transponder codes. Full vehicle security reset after key theft or second-hand purchase. Call 07711 341668.',
...
const faqs = [
  {
    ...
    answer: 'Car rekeying is the process of replacing a vehicle\'s lock barrels and erasing all previously registered transponder key codes from the ECU, then programming new keys from scratch. The result is that no existing key — whether lost, stolen, or held by a previous owner — can unlock or start the vehicle. It\'s a complete security reset.',
  },
  {
  ...
  },
  {
    ...
    answer: 'They are similar but not identical. AKL programming erases and reprogrammes the transponder system when no working keys exist. Car rekeying goes further — it also physically replaces the door lock barrels and ignition barrel, so that even a key with the correct blade profile cannot operate the locks mechanically. It\'s a more comprehensive security reset.',
  },
  {
    question: 'How long does car rekeying take?',
    answer: 'A full car rekeying — replacing door locks, ignition, and reprogramming the transponder system — typically takes 2–3 hours depending on the vehicle. Some makes require specific barrel kits that may need to be ordered in advance. We\'ll advise on lead time when you call.',
  },
  {
    question: 'Will I get new keys after rekeying?',
    answer: 'Yes. The rekeying process includes cutting new keys to the new barrel profile and programming new transponder chips. You\'ll receive fully functioning replacement keys — typically two — that start the engine and operate all remote functions.',
  },
  {
    question: 'How much does car rekeying cost in Ashton-in-Makerfield?',
    answer: 'Car rekeying is more involved than a standard key replacement due to the physical barrel replacement and full transponder reset. Costs typically start from £250–£400 depending on the vehicle make, model, and how many lock barrels are being replaced. Full pricing confirmed before we begin.',
  },
]
...
export default function CarRekeyingAshtonPage() {
  ...
  const schemas = [
    serviceSchema('Car Rekeying Ashton-in-Makerfield', 'Full vehicle security reset in Ashton-in-Makerfield — new lock barrels, erase old transponder codes, programme new keys. Mobile service to your vehicle.', pageUrl),
    faqSchema(faqs),
    ...
    webPageSchema({ url: pageUrl, title: 'Car Rekeying Ashton-in-Makerfield | Full Security Reset', description: 'Car rekeying in Ashton-in-Makerfield. New lock barrels, transponder reset, new keys — full vehicle security reset.', type: 'WebPage' }),
  ]
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-navy to-brand-blue section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Full Vehicle Security Reset — Ashton-in-Makerfield &amp; Wigan
          </div>
          ...
          <p className="text-xl text-white/70 mb-4 leading-relaxed">
            ...
            provides full car rekeying in Ashton-in-Makerfield — replacing lock barrels and erasing all
          ...
          <p className="text-lg text-white/60 mb-8 leading-relaxed">
            ...
            complete security reset. Mobile service — we come to your vehicle.
          </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            Standard key replacement removes one lost or damaged key from the equation — but it doesn&apos;t
            ...
            data from the ECU, it ensures that only the new keys — in your possession — can access and
          ...
          <ul>
            <li><strong>Second-hand vehicle purchase</strong> — you have no way of knowing how many keys were made for the vehicle or who has copies</li>
            <li><strong>Key theft</strong> — even if the key is later recovered, you can&apos;t be certain it wasn&apos;t cloned</li>
            <li><strong>Domestic disputes or shared vehicles</strong> — where you need to restrict access to specific individuals</li>
            <li><strong>Fleet vehicle turnover</strong> — ensuring departing drivers can no longer access vehicles</li>
          </ul>
          ...
          <p>
            Car rekeying includes the supply and programming of replacement keys — typically two.
      ...
      <section className="section-padding bg-white" aria-labelledby="vehicles-heading">
        <div className="container-max max-w-4xl mx-auto">
          ...
          <p className="text-center text-gray-500 text-sm">
            <a href={`tel:${BUSINESS.phone}`} className="text-brand-orange font-semibold hover:underline">Call {BUSINESS.phoneDisplay}</a> — we&apos;ll confirm parts availability and quote before attending.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="prose-custom">
              <p>
                ...
                We come to your vehicle — no need for recovery.
              </p>
              <p>Coverage areas:</p>
              <ul>
      ...
      <CTASection variant="orange" heading="Need a Full Security Reset in Ashton-in-Makerfield?" subtext="Call Ashton Lock & Key — new barrels, new keys, old codes permanently erased." />
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { title: 'Car Key Replacement', desc: 'Standard key replacement — simpler than full rekeying.', href: '/car-key-replacement-ashton-in-makerfield' },
