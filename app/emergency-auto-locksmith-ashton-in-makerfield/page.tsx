...
export const metadata: Metadata = {
  ...
  description: '24/7 emergency auto locksmith in Ashton-in-Makerfield. Any vehicle situation — lockout, lost keys, broken key. 20–30 min response. No call-out fee. Call 07711 341668 now.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We are based in Ashton-in-Makerfield at WN4 — most call-outs within the WN4 postcode are reached within 20–25 minutes. Wigan and surrounding areas are typically 25–35 minutes. The exact ETA is confirmed when you call.',
  },
  {
    question: 'Is there a call-out fee for emergency auto locksmith work?',
    answer: 'No. There is no call-out fee. You pay a fixed price for the job itself — confirmed over the phone before we set off. There are no hidden extras, no surcharges for out-of-hours work beyond the stated out-of-hours rate.',
  },
  {
    question: 'Do you operate 24 hours including weekends and bank holidays?',
    answer: 'Yes. The emergency auto locksmith line is staffed 24 hours a day, 365 days a year. When you call, you speak directly to the locksmith — not a call centre. Bank holidays, Christmas Day, New Year\'s Eve — we answer.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. We cover cars, vans, and light commercial vehicles. If you\'re a tradesperson locked out of your van in Ashton-in-Makerfield or Wigan, call us — we open Transit, Vivaro, Sprinter, Transporter, and all other common van makes.',
  },
]
...
export default function EmergencyAutoLocksmithAshtonPage() {
  ...
  const schemas = [
    serviceSchema('Emergency Auto Locksmith Ashton-in-Makerfield', '24/7 emergency auto locksmith in Ashton-in-Makerfield. Any vehicle situation — 20–30 min response, no call-out fee, fixed price.', pageUrl),
    faqSchema(faqs),
    ...
    webPageSchema({ url: pageUrl, title: 'Emergency Auto Locksmith Ashton-in-Makerfield | 24/7', description: '24/7 emergency auto locksmith in Ashton-in-Makerfield. 20–30 min response, no call-out fee.', type: 'WebPage' }),
  ]
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-navy to-brand-blue section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Available Now — 24/7 Emergency Auto Locksmith, Ashton-in-Makerfield
          </div>
          ...
          <p className="text-xl text-white/70 mb-4 leading-relaxed">
            ...
            snapped a key in the lock, or your ignition has seized — Ashton Lock &amp; Key is your local
            24/7 emergency auto locksmith. We respond to WN4 call-outs within 20–30 minutes and you speak
            directly to the locksmith when you call.
          </p>
          <p className="text-lg text-white/60 mb-8 leading-relaxed">
            No call-out fee. Fixed price confirmed before we set off. No call centres — when you ring
            {' '}{BUSINESS.phoneDisplay}, you get the locksmith. Available every hour of every day,
            including bank holidays.
          </p>
          <div className="flex flex-wrap gap-3 mb-8">
            {['No Call-Out Fee', '24/7 Including Bank Holidays', '20–30 Min WN4 Response', 'Speak to the Locksmith Direct', 'Fixed Price Before We Set Off'].map(t => (
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href={`tel:${BUSINESS.phone}`} className="btn-primary text-xl py-5 px-8">
              ...
              Call {BUSINESS.phoneDisplay} Now — 24/7
            </a>
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            A vehicle emergency can happen at any hour — and when it does, you need a local locksmith
          ...
          <ul>
            <li><strong>Car lockout</strong> — keys on the seat, in the boot, or left in the ignition</li>
            <li><strong>Lost all keys</strong> — all-keys-lost programming, V5C required</li>
            <li><strong>Broken key in lock or ignition</strong> — extraction and replacement same visit</li>
            <li><strong>Failed key fob</strong> — re-sync, repair, or emergency replacement</li>
            <li><strong>Seized ignition</strong> — diagnosis, repair, or barrel replacement</li>
            <li><strong>Boot locked with keys inside</strong> — non-destructive boot access</li>
            <li><strong>Van lockout</strong> — all common makes including Transit, Vivaro, Sprinter</li>
          </ul>
          ...
          <p>
            We&apos;re genuinely local — based in Ashton-in-Makerfield, not a national franchise routing
      ...
      <section className="section-padding bg-white" aria-labelledby="vehicles-heading">
        <div className="container-max max-w-4xl mx-auto">
          ...
          <p className="text-center text-gray-500 text-sm">
            <a href={`tel:${BUSINESS.phone}`} className="text-brand-orange font-semibold hover:underline">Call {BUSINESS.phoneDisplay}</a> — available 24/7, fixed price, no call-out fee.
          </p>
        </div>
      </section>
      ...
      <CTASection variant="orange" heading="Vehicle Emergency in Ashton-in-Makerfield?" subtext="Call Ashton Lock & Key now — 24/7, no call-out fee, fixed price, 20–30 min WN4 response." />
