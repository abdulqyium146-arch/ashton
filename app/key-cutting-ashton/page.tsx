...
export const metadata: Metadata = {
  ...
  description: 'Professional key cutting in Ashton-in-Makerfield. House keys, office keys, padlock keys â€” precision-cut while you wait. Call 07309 903243 for same-day key cutting.',
  alternates: {
...
const faqs = [
  {
    ...
    answer: 'Standard house keys start from Â£3â€“Â£6 each. High-security keys (Mul-T-Lock, Abloy, Banham) cost more depending on the blank. We always tell you the price before we cut anything.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Most standard keys take under 5 minutes. High-security keys can take a little longer. Either way, it\'s a quick job â€” we won\'t keep you hanging around.',
  },
  {
...
const keyTypes = [
  ...
  { name: 'Chubb Keys', desc: 'Mortice lock keys for 2, 3 and 5-lever locks â€” the type you\'ll find on most older doors.' },
  { name: 'Euro Cylinder Keys', desc: 'Double-sided euro profile keys for modern uPVC and composite doors.' },
  { name: 'High-Security Keys', desc: 'Mul-T-Lock, Banham, Abloy and other patented keys â€” with proper authorisation.' },
...
export default function KeyCuttingPage() {
  const schemas = [
    ...
    webPageSchema({
      ...
      description: 'Professional key cutting in Ashton-in-Makerfield for all key types. From Â£3.',
      type: 'ItemPage',
    }),
  ]
        ...
        <div className="container-max grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-white/10 text-white/80 text-sm font-semibold px-4 py-2 rounded-full mb-6">
              ...
              Professional Key Cutting â€” Ashton-in-Makerfield
            </div>
            ...
            <p className="text-xl text-white/70 mb-6 leading-relaxed">
              Need a spare for your son who keeps losing his, or a key for the new tenant? We cut all key types while you wait â€”
              usually in under 5 minutes. Fast, accurate, and affordable.
            </p>
            <div className="flex flex-wrap gap-3 mb-8">
              {['From Â£3 Per Key', 'All Key Types', 'Same-Day Service', 'High Security Keys', 'No Appointment Needed'].map((t) => (
        ...
        <div className="container-max max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-10">
            <div className="prose-custom">
              <h2>Key Cutting in Ashton-in-Makerfield â€” Quick and Reliable</h2>
              <p>
                Getting a key cut is one of those jobs that takes five minutes and saves you a world of grief later. At Ashton Lock & Key,
                we use precision cutting machines and carry blanks for an enormous range of key types â€” Yale, Chubb, euro cylinder,
            ...
            <div className="space-y-4">
              <div className="rounded-2xl overflow-hidden shadow-md">
                <Image
                  ...
                  alt="Professional key cutting machine at Ashton Lock & Key â€” precision cutting for all key types in Ashton-in-Makerfield"
                  width={560}
                  height={420}
          ...
          <h2>Get a Spare Key â€” Before You Need It</h2>
          <p>
            ...
            We&apos;d suggest keeping at least two spare keys per lock â€” one with a trusted neighbour, one in a safe place at work.
          </p>

          <h2>High-Security Key Cutting in Ashton</h2>
          <p>
            Mul-T-Lock, Abloy, Banham â€” high-security keys with patented blanks can&apos;t just be cut on any machine. They
          ...
          <ul>
            <li><strong>Standard Yale / flat-blade key:</strong> From Â£3</li>
            <li><strong>Mortice / Chubb key:</strong> From Â£5</li>
            <li><strong>Euro cylinder key:</strong> From Â£6</li>
            <li><strong>High-security / patented key:</strong> From Â£15 (+ authorisation)</li>
            <li><strong>Padlock key:</strong> From Â£3</li>
          </ul>
          <p>
            Prices are per key. Cutting multiple keys at the same time? We can offer a discount.
            Car key replacement is a different job â€” see our <Link href="/car-key-replacement-wigan">car key replacement service in Wigan</Link> for that.
          </p>
          ...
          <p>
            ...
            practical upgrades that make a real difference â€” including whether your cylinders are anti-snap rated. If you
