...
export const metadata: Metadata = {
  ...
  description: 'Key fob not working in Ashton-in-Makerfield? We re-sync, repair, or replace remote fobs for all makes. Lost pairing, flat battery, or physical damage fixed on-site. Call 07309 903243.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes. If the fob has lost its pairing with the vehicle â€” but the internal circuit and transponder are intact â€” re-synchronisation is a straightforward process. We connect to the car via OBD diagnostics and re-register the fob. This is considerably cheaper than a full fob replacement.',
  },
  {
    question: 'My key fob works intermittently â€” is it worth repairing?',
    answer: 'Intermittent fob issues are often caused by worn button contacts or a hairline crack in the circuit board â€” both of which are repairable. We assess the fob and give you an honest recommendation: repair if cost-effective, replace if not. We won\'t charge for a replacement if a Â£20 repair will fix it.',
  },
  {
    question: 'Can I just replace the battery myself?',
    answer: 'Yes â€” a flat battery is the first thing to try, and it\'s a simple DIY fix for most fobs. The battery type is usually CR2032 or CR2025, available at any supermarket. If replacing the battery doesn\'t resolve the issue, the fob will need professional diagnosis.',
  },
  {
    question: 'Do you programme key fobs for all car makes?',
    answer: 'We programme and re-sync fobs for Vauxhall, Ford, VW, BMW, Audi, Mercedes-Benz, Toyota, Nissan, Renault, Peugeot, Kia, Hyundai, Honda, Skoda, Seat, CitroÃ«n, Fiat, and many more. Call us with your make and model to confirm.',
  },
  {
    question: 'How much does key fob programming cost?',
    answer: 'Re-synchronisation starts from Â£50. A full fob replacement (supply and programme) starts from Â£100, depending on make and model. Pricing is confirmed before we attend.',
  },
]
...
export default function KeyFobProgrammingAshtonPage() {
  ...
  const schemas = [
    serviceSchema('Key Fob Programming Ashton-in-Makerfield', 'Remote key fob programming, re-sync, and repair in Ashton-in-Makerfield. All makes â€” diagnosed and fixed on-site.', pageUrl),
    faqSchema(faqs),
    ...
    webPageSchema({ url: pageUrl, title: 'Key Fob Programming Ashton-in-Makerfield | Re-sync & Repair', description: 'Key fob programming, re-sync and repair in Ashton-in-Makerfield. All makes â€” on-site service.', type: 'WebPage' }),
  ]
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-brand-navy to-brand-blue section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Key Fob Programming &amp; Repair â€” Ashton-in-Makerfield &amp; Wigan
          </div>
          ...
          <p className="text-xl text-white/70 mb-4 leading-relaxed">
            ...
            across Ashton-in-Makerfield and Wigan â€” re-syncing lost pairing, repairing damaged circuits,
          ...
          <p className="text-lg text-white/60 mb-8 leading-relaxed">
            ...
            the problem â€” saving you the cost of a new fob when only the pairing or battery contact
            needs attention.
          </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            ...
            minor fault in the fob&apos;s circuit board â€” all of which are fixable without buying a
          ...
          <h3>Diagnosis â€” What We Check</h3>
          <p>
            ...
            â€” both repairable. If the chip isn&apos;t registering at all, we determine whether it&apos;s
          ...
          <p>
            ...
            after another key was programmed by an inexperienced technician. Re-sync is quick â€”
            typically 15â€“20 minutes â€” and significantly cheaper than a full replacement.
          </p>
          <h3>Fob Repair</h3>
          <p>
            Physical damage â€” cracked housing, worn button contacts, broken circuit traces â€” can
          ...
          <p>
            ...
            before we leave â€” full remote and transponder function confirmed.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-white" aria-labelledby="vehicles-heading">
        <div className="container-max max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-6 max-w-2xl mx-auto">
            ...
            Toyota, Nissan, Renault, Peugeot, Kia, Hyundai, Honda, Skoda, Seat, CitroÃ«n, Fiat</strong>,
          ...
          <p className="text-center text-gray-500 text-sm">
            <a href={`tel:${BUSINESS.phone}`} className="text-brand-orange font-semibold hover:underline">Call {BUSINESS.phoneDisplay}</a> â€” we&apos;ll diagnose your fob issue over the phone where possible.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="prose-custom">
              <p>
                ...
                We come to your vehicle for all fob work â€” no need to visit a dealer or post your key away.
              </p>
      ...
      <CTASection variant="orange" heading="Key Fob Not Working in Ashton-in-Makerfield?" subtext="Call Ashton Lock & Key â€” we diagnose and fix fobs on-site. Re-sync, repair, or replacement." />
