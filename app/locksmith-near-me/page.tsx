...
export const metadata: Metadata = {
  title: 'Locksmith Near Me â€” Wigan & Ashton-in-Makerfield | 24/7',
  description: 'Searching for a locksmith near me in Wigan or Ashton-in-Makerfield? Ashton Lock & Key is your nearest local locksmith. 24/7 emergency service, 30-min response. Call 07309 903243.',
  alternates: {
...
const faqs = [
  {
    ...
    answer: 'We\'re based in Ashton-in-Makerfield itself â€” it doesn\'t get more local. For most addresses in WN4, we\'re knocking on your door within 20â€“30 minutes of calling.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Just ring us on 07309 903243 and tell us where you are. If we can reach you within a reasonable time, we will. We cover a wide radius from Ashton-in-Makerfield, including areas bordering Greater Manchester and Merseyside.',
  },
]
...
export default function LocksmithNearMePage() {
  ...
  const schemas = [
    serviceSchema(
      'Locksmith Near Me â€” Wigan & Ashton-in-Makerfield',
  ...
  return (
    <>
      ...
      <section className="bg-brand-navy section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Genuinely Local â€” Ashton-in-Makerfield Based
          </div>
          <h1 id="page-heading" className="text-4xl md:text-5xl font-black text-white mb-4 leading-tight">
            Locksmith <span className="text-brand-orange">Near Me</span> â€” Wigan & Ashton
          </h1>
          <p className="text-xl text-white/70 mb-8 leading-relaxed">
            If you&apos;re in the Wigan area, you&apos;ve found your nearest locksmith. Ashton Lock & Key is based in
            Ashton-in-Makerfield â€” genuinely local, genuinely fast, and upfront about pricing.
          </p>
      ...
      <section className="section-padding bg-white" aria-labelledby="coverage-heading">
        <div className="container-max">
          ...
          <p className="text-center text-gray-500 text-sm max-w-xl mx-auto">
            Don&apos;t see your area? Call us anyway â€” if we can reach you, we will.
            Our typical coverage radius is approximately 15â€“20 miles from Ashton-in-Makerfield.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-brand-light">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            ...
            well-documented problem with rogue traders â€” companies that advertise Â£25 call-outs, then hit you with
          ...
          <p>
            ...
            At Ashton Lock & Key, the price you&apos;re quoted is the price you pay â€” full stop.
          </p>
          ...
          <p>
            ...
            specific local streets, areas, or circumstances. Ashton Lock & Key has 127+ reviews with a 4.9â˜… rating
            from real customers in Ashton, Wigan, Leigh, Golborne, and the surrounding area.
          </p>
          <h3>They&apos;re Fully Insured</h3>
          <p>
            We carry full public liability insurance. It rarely matters â€” but when it does, you want it in place.
          </p>

          <h2>Our Locksmith Services Near You</h2>
          <ul>
            <li><Link href="/emergency-locksmith-ashton-in-makerfield">Emergency Locksmith Ashton-in-Makerfield</Link> â€” 24/7 lockout service</li>
            <li><Link href="/key-cutting-ashton">Key Cutting Ashton</Link> â€” All key types, while you wait</li>
            <li><Link href="/car-key-replacement-wigan">Car Key Replacement Wigan</Link> â€” All makes, cheaper than dealers</li>
            <li><Link href="/locksmith-wigan">Locksmith Wigan</Link> â€” Full coverage across Wigan Borough</li>
            <li><Link href="/locksmith-ashton-in-makerfield">Locksmith Ashton-in-Makerfield</Link> â€” Your local WN4 expert</li>
          </ul>
          ...
          <p>
            ...
            honest, transparent figures â€” so you can compare quotes with confidence and avoid the inflated bills that
      ...
      <TrustBadges />
      <CTASection variant="orange" heading="Found Your Local Locksmith?" subtext="Call Ashton Lock & Key â€” your nearest trusted locksmith in Ashton-in-Makerfield and Wigan." />
