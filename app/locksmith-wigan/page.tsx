...
export const metadata: Metadata = {
  ...
  description: 'Need a locksmith in Wigan? Ashton Lock & Key provides emergency lockouts, key cutting & car key replacement across Wigan. 24/7, fast response. Call 07309 903243.',
  alternates: {
...
const faqs = [
  {
    ...
    answer: 'Yes â€” we cover the whole of the Wigan Metropolitan Borough. We\'re based in Ashton-in-Makerfield, which puts us within 30â€“40 minutes of most Wigan locations. Wigan town centre, Leigh, Hindley, Aspull, Golborne, Orrell â€” all covered.',
  },
  {
    question: 'Is there a 24/7 locksmith available in Wigan?',
    answer: 'Yes. We\'re available 24 hours a day, 365 days a year â€” bank holidays and Christmas included. Call 07309 903243 at any hour and you\'ll get through to a locksmith, not an answering service.',
  },
  {
    question: 'How much does a locksmith charge in Wigan?',
    answer: 'Standard daytime lockouts from Â£60. Out-of-hours from Â£80. Key cutting from Â£3 per key. Car key replacement from Â£80 depending on the vehicle. All prices include VAT and are confirmed before we start anything.',
  },
]
...
export default function LocksmithWiganPage() {
  ...
  const schemas = [
    serviceSchema(
      'Locksmith Wigan',
      'Professional locksmith services across the Wigan borough â€” emergency lockouts, key cutting, car key replacement. Based in Ashton-in-Makerfield, covering all WN postcodes. Available 24/7.',
      pageUrl,
    ),
    faqSchema(faqs),
    breadcrumbSchema([
      ...
      <section className="bg-brand-navy section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-3xl">
          ...
          <p className="text-xl text-white/70 mb-8 leading-relaxed">
            ...
            Ashton Lock & Key covers the whole of the Wigan borough â€” 24 hours a day, 7 days a week.
          </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-10">
            <div className="rounded-2xl overflow-hidden shadow-md">
              <Image
                ...
                alt="Ashton Lock & Key locksmith van serving Wigan borough â€” Ford Transit fully equipped for all locksmith services"
                width={600}
                height={450}
            ...
            <div className="rounded-2xl overflow-hidden shadow-md">
              <Image
                ...
                alt="Ashton Lock & Key security products and locksmith supplies â€” extensive stock available for Wigan area customers"
                width={600}
                height={450}
                sizes="(max-width: 1024px) 100vw, 45vw"
                className="w-full h-auto object-cover"
          ...
          <p>
            ...
            Wigan Metropolitan Borough â€” from Wigan itself through to Leigh, Atherton, Golborne, Hindley, and Aspull.
            Most locations in the borough are within 30â€“40 minutes of us.
          </p>
          <p>
            We&apos;re a genuine local operation. When you call, you speak directly to a locksmith â€” not a call centre that
            subcontracts to whoever is available. That means honest pricing, accurate ETAs, and proper accountability.
          </p>

          <h2>Emergency Locksmith in Wigan â€” 24/7</h2>
          <p>
            ...
            no extra charge just for calling outside office hours â€” only the standard out-of-hours rate applies, and
          ...
          <p>
            ...
            All cut on-site in minutes â€” no need to come to us.
          </p>
          ...
          <p>
            ...
            covers all makes and models. We come to wherever the vehicle is â€” home, work, roadside â€” and programme
          ...
          <p>
            ...
            every job â€” lockouts, key cutting, car keys â€” so you know what to expect and how to spot a rogue trader.
          ...
          <p>
            ...
            genuinely local option â€” no national call centres, no subcontractors.
          </p>
          </div>
        </div>
      </section>
