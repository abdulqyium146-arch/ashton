...
export const metadata: Metadata = {
  ...
  description: 'Transponder key programming for all UK makes in Ashton-in-Makerfield. AUTEL & Xhorse diagnostic equipment. Key addition, AKL & immobiliser resets. Call 07309 903243.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Often yes, but it depends on the key type and vehicle. Some aftermarket transponder blanks are compatible with our programming equipment; others aren\'t. Before buying a key elsewhere, call us â€” we can confirm compatibility and advise whether it\'s worth purchasing independently or whether we should supply the blank ourselves.',
  },
  {
    question: 'Do I need my existing key present for transponder programming?',
    answer: 'For a standard key addition, yes â€” you\'ll need at least one working key to authorise the new key. If you have no working keys, that requires all-keys-lost (AKL) programming, which is a different process â€” see our lost car key service.',
  },
  {
    question: 'Which makes and models do you programme transponder keys for?',
    answer: 'Using AUTEL MaxiIM and Xhorse VVDI equipment, we cover the vast majority of UK-sold vehicles from 1995 onwards. This includes Ford, Vauxhall, VW, Audi, BMW, Mercedes-Benz, Renault, Peugeot, CitroÃ«n, Nissan, Toyota, Kia, Hyundai, Honda, Skoda, Seat, Fiat, and many others. Call us if you have a specific model to confirm.',
  },
  {
    question: 'How long does transponder key programming take?',
    answer: 'Standard key addition (programming a second key to a vehicle with one working key) takes around 20â€“40 minutes on-site. All-keys-lost programming takes 1â€“2 hours. Smart key and proximity key programming may take slightly longer depending on the make.',
  },
  {
    question: 'What does transponder key programming cost?',
    answer: 'Pricing depends on key type, make/model, and whether it\'s a key addition or AKL job. Transponder key addition starts from Â£80â€“Â£120. AKL starts from Â£180. Prices are confirmed over the phone â€” call us with the make, model, and year for an accurate quote.',
  },
]
...
export default function TransponderKeyProgrammingAshtonPage() {
  ...
  const schemas = [
    ...
    webPageSchema({ url: pageUrl, title: 'Transponder Key Programming Ashton-in-Makerfield', description: 'Transponder key programming in Ashton-in-Makerfield. AUTEL & Xhorse equipment â€” all common UK makes.', type: 'WebPage' }),
  ]
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-brand-navy to-brand-blue section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Professional Transponder Programming â€” Ashton-in-Makerfield &amp; Wigan
          </div>
          ...
          <p className="text-xl text-white/70 mb-4 leading-relaxed">
            ...
            on-site in Ashton-in-Makerfield â€” using AUTEL MaxiIM and Xhorse VVDI diagnostic equipment,
            the same tools used by main dealers.
          </p>
          <p className="text-lg text-white/60 mb-8 leading-relaxed">
            Key addition, all-keys-lost programming, and immobiliser resets â€” all carried out at your vehicle,
            no recovery required. Most standard key additions are completed within 30â€“40 minutes.
          </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          ...
          <p>
            ...
            the engine won&apos;t start â€” the immobiliser cuts fuel and spark before the engine fires.
          ...
          <p>
            ...
            programmers â€” industry-standard tools that support the vast majority of vehicle makes sold
            in the UK. These are the same devices used by franchised dealers, which means our
            programming is not a workaround or aftermarket approximation â€” it&apos;s the correct
          ...
          <p>
            ...
            scratch. We carry the tools required for AKL on most common UK vehicles â€” see our
          ...
          <p>
            If the immobiliser is triggering incorrectly â€” preventing a correctly programmed key from
            starting the vehicle â€” we can diagnose and reset the system using our diagnostic equipment.
      ...
      <section className="section-padding bg-white" aria-labelledby="vehicles-heading">
        <div className="container-max max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-6 max-w-2xl mx-auto">
            ...
            Peugeot, CitroÃ«n, Nissan, Toyota, Kia, Hyundai, Honda, Skoda, Seat, Fiat, Volvo,
      ...
      <CTASection variant="orange" heading="Need a Transponder Key Programmed in Ashton-in-Makerfield?" subtext="Call Ashton Lock & Key â€” AUTEL & Xhorse equipment, on-site programming, all common UK makes." />
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { title: 'Car Rekeying', desc: 'Full security reset â€” erase all old key codes.', href: '/car-rekeying-ashton-in-makerfield' },
