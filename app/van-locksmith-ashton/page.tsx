...
export const metadata: Metadata = {
  ...
  description: 'Van locksmith in Ashton-in-Makerfield. Van lockouts, van key replacement, deadlock fitting, and slam lock installation. 24/7 commercial vehicle service. Call 07711 341668.',
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes. Van deadlocks are one of the most effective deterrents against van break-ins — the standard slam lock is vulnerable to relay attacks and physical compromise, while a properly fitted deadlock requires the key to be present. We supply and fit Deadlocks, Van Vault locks, and slam locks from leading manufacturers.',
  },
  {
    question: 'Can you replace van keys including Vauxhall Vivaro, Ford Transit, and Mercedes Sprinter?',
    answer: 'Yes. We cover key replacement and programming for all common commercial vans including Ford Transit, Ford Transit Custom, Vauxhall Vivaro, Renault Trafic, Mercedes Sprinter, Volkswagen Transporter, Citroën Dispatch, Peugeot Expert, and Fiat Ducato.',
  },
  {
    question: 'I\'m a sole trader — can you come to wherever my van is broken down?',
    answer: 'Yes. We\'re mobile — we come to wherever your vehicle is. If your van is at a job site, a depot, a roadside, or your home address, we\'ll attend. For urgent commercial call-outs, ring us and we\'ll give you an honest ETA.',
  },
]
    ...
    <>
      ...
      <section className="bg-brand-navy section-padding" aria-labelledby="page-heading">
        <div className="container-max max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold px-4 py-2 rounded-full mb-6">
            ...
            Commercial Vehicle Specialists — Ashton-in-Makerfield
          </div>
          ...
          <p className="text-xl text-white/70 mb-8 leading-relaxed">
            ...
            We cover all commercial vehicle locksmith needs in Ashton-in-Makerfield — 24/7, mobile, fast.
          </p>
      ...
      <section className="section-padding bg-brand-light" aria-labelledby="vanservices-heading">
        <div className="container-max max-w-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { title: 'Van Lockout Service', desc: 'Locked keys in van — non-destructive entry for all common makes.' },
              { title: 'Van Key Replacement', desc: 'Lost or stolen van keys replaced and programmed on-site.' },
              { title: 'Deadlock Fitting', desc: 'High-security deadlocks fitted to van load doors — protects tools.' },
              ...
              { title: 'Broken Key Extraction', desc: 'Key snapped in van door or ignition — removed without damage.' },
            ].map((svc) => (
      ...
      <section className="section-padding bg-white">
        <div className="container-max max-w-4xl mx-auto prose-custom">
          <h2>Van Security — Why Deadlocks Matter</h2>
          <p>
            Van break-ins are a significant problem across the North West. Standard OEM slam locks on most vans
            can be compromised relatively quickly using techniques that don&apos;t damage the exterior — making it look
            like the vehicle was never touched. If your van is your livelihood and carries thousands of pounds of
            tools, the cost of a deadlock (typically £80–£150 fitted) is negligible compared to a single theft.
          </p>
          <p>
          ...
          <p>
            ...
            Mercedes Sprinter, Volkswagen Transporter (T5/T6), Citroën Dispatch / Relay, Peugeot Expert / Boxer,
            Fiat Ducato, Nissan NV200 / NV300 / NV400, Toyota Proace, Iveco Daily.
          </p>
          <p>
            Don&apos;t see your van listed? Call us — we almost certainly cover it.
          </p>

          <h2>Emergency Van Lockout — Any Hour, Any Location</h2>
          <p>
      ...
      <CTASection
        ...
        subtext="Locked out, lost keys, or need a deadlock fitted? Call Ashton Lock & Key — 24/7, mobile, fixed price."
      />
